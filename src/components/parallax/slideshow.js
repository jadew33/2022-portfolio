  ...
  return (
    <div className="parallax2">
      <div className="parallax2--wrapper">
        ...
        <div
          className={`pos parallax2--second `}
          style={{ backgroundPosition: `${-(0.5 * catX)}px` }}
        />
        <div
          className={`pos parallax2--third`}
      ...
      <div className="nav">
        {catX > 0 && (
          <div className="nav-left" onClick={() => updateCatPos(-0.2 * width)}>
            <svg
        ...
        {catX < 0.8 * width && (
          <div className="nav-right" onClick={() => updateCatPos(0.2 * width)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
